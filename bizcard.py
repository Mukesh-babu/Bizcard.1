...
icon = Image.open("C:/Users/FCI/OneDrive/Desktop/New folder/bizcard/1.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Mukesh Babu",
                   page_icon= icon,
                   layout="wide",
